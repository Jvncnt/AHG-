...
module.exports.getAllEmployeeByCompanyService = async (id) => {
    try{
        const [ result ] = (await databaseQuery(`SELECT * FROM employee WHERE team_id IN (SELECT id FROM team WHERE company_id = ${id} )`)).rows
